...
Label(win, text='Giải hệ phương trình n ẩn', font=('Times New Roman', 13), bg='yellow', fg='black', height=2,
      relief='solid', borderwidth=2, width=40).place(x=250, y=0)

sopt = StringVar()
Label(win, text='Nhập số phương trình', font=('Times New Roman', 13), bg='yellow', fg='black', height=2, relief='solid',
      borderwidth=2, width=30).place(x=250, y=55)
Entry(win, textvariable=sopt, font=('Times New Roman', 14), bg='yellow', fg='black', relief='solid', borderwidth=2,
        ...
        try:
            ...
            for i in range(int(sopt.get())):
                ...
                for j in range(int(sopt.get())):
                    ...
                    if (i != 0):
                        Label(win, background='#E3F7F2', font=('Times New Roman', 12), text=' + ' + f'x{i} ',
                              width=3).place(x=250 + 80 * i, y=110 + 30 * j)  # grid(row = i, column = j+2)
                    else:
                        Label(win, background='#E3F7F2', font=('Times New Roman', 12), text=f'x{i} ', width=3).place(
                            x=250 + 80 * i, y=110 + 30 * j)  # grid(row = i, column = j+2)
                ...
                Label(win, background='#E3F7F2', font=('Times New Roman', 12), text=f' = ', width=3).place(
                    x=310 + 83 * (int(sopt.get()) - 1), y=110 + 30 * i)  # grid(row = i, column = 4)
        ...
        try:
            ...
            if (A.det() != 0):
                ...
                if (A.rank() == A_.rank() and A.rank() == int(sopt.get())):
                    ...
                    print(X)
                    for i in range(int(sopt.get())):
                        Label(win, background='#E3F7F2', font=('Times New Roman', 12), fg='White', text=f'x{i} = ',
                              width=4).place(x=280 + 83 * i, y=650)  # grid(row = i, column = 4)
                        Label(win, background='#E3F7F2', font=('Times New Roman', 12), fg='White',
                              text=f'{float(round((X[i]), 3))}' + ', ', width=4).place(x=320 + 83 * i,
                                                                                       y=650)  # grid(row = i, column = 4)
                if (A.rank() == A_.rank() and A.rank() < int(sopt.get())):
...
def clear():
    ...
    Button(win, text='Create', command=cal.create, font=('Times new roman', 15), fg='black', bg='brown', width=6,
           height=2, relief='solid', borderwidth=2).place(x=280, y=710)
    Button(win, text='Exit', command=exit, font=('Times new roman', 15), fg='black', bg='brown', width=6, height=2,
           relief='solid', borderwidth=2).place(x=380, y=710)
    Button(win, text='Clear', command=clear, font=('Times new roman', 15), fg='black', bg='brown', width=6, height=2,
           relief='solid', borderwidth=2).place(x=480, y=710)
    Button(win, text='Calculate', command=cal.calculate, font=('Times new roman', 15), fg='black', bg='brown', width=8,
           height=2, relief='solid', borderwidth=2).place(x=580, y=710)


cal = Cal(A, entries_A, B, entries_B)
Button(win, text='Create', command=cal.create, font=('Times new roman', 15), fg='black', bg='brown', width=6, height=2,
       relief='solid', borderwidth=2).place(x=280, y=710)
Button(win, text='Exit', command=exit, font=('Times new roman', 15), fg='black', bg='brown', width=6, height=2,
       relief='solid', borderwidth=2).place(x=380, y=710)
Button(win, text='Clear', command=clear, font=('Times new roman', 15), fg='black', bg='brown', width=6, height=2,
       relief='solid', borderwidth=2).place(x=480, y=710)
